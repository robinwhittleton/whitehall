...
class WorldWriterWorldwidePriorityTest < ActiveSupport::TestCase
  ...
  test "can create a new worldwide priority" do
    assert enforcer_for(world_writer(["hat land"]), WorldwidePriority).can?(:create)
  end
  ...
  test "cannot publish a worldwide priority that is about their location and not access limited" do
    user = world_writer(["hat land", "tie land"])
    edition = with_locations(normal_worldwide_priority, ["shirt land", "hat land"])
  ...
  test "cannot reject a worldwide priority that is about their location and not access limited" do
    user = world_writer(["hat land", "tie land"])
    edition = with_locations(normal_worldwide_priority, ["shirt land", "hat land"])
  ...
  test "cannot force publish a worldwide priority that is about their location and not access limited" do
    user = world_writer(["hat land", "tie land"])
    edition = with_locations(normal_worldwide_priority, ["shirt land", "hat land"])
